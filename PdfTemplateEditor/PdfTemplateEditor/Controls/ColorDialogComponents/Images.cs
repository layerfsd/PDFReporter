...
namespace AxiomCoders.PdfTemplateEditor.Controls
{
	class ImagesUtil
	{
		...
		{
            System.Drawing.Bitmap bitmap = new System.Drawing.Bitmap(AxiomCoders.PdfTemplateEditor.Properties.Resources.colorbarIndicators);
	...
	class SelectorImages
	{
		...
		static public ImageList ImageList()
		{
			...
			if (m_imageList == null)
                m_imageList = ImagesUtil.GetToolbarImageList(t, "Nesto", new Size(12, 12), Color.Magenta);
			return m_imageList;
		}
